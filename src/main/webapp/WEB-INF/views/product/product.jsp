  ...
  <div class="content-push container">
    ...
    <div class="information-blocks">
      ...
      <div class="inline-product-entry">
        ...
        <div class="col-md-4">
            <div style="margin-top: 10%"> <input type="file" id="attachFile" name="attachFile"> </div>
...
function printList(data) {
  ...
  $(data.list).each( function(){
    ...
    str += '<a class="comment-image" href="#"><img src="/resources/img/comment-1.jpg" alt="" /></a>';
    ...
    str += '<div class="comment-text">' + this.content + ' </div>';
    str += '</div>';
    str += '</div>';
    str += '</div>';
    str += '<div class="column-2">';
    str += '<a class="button style-14">더보기</a>';
    str += '<a class="remove-button"><i class="fa fa-times"></i></a>';
    str += '</div> ';
    str += '</div>';
