...
public class GpurchaseController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/gresearch/{gpurchaseNo}", method=RequestMethod.GET)	
	public ResponseEntity<Map<String, Object>> researchSelect(@PathVariable("gpurchaseNo") int gpurchaseNo, @RequestParam(value="memberNo", defaultValue="1") int memberNo) throws Exception {
